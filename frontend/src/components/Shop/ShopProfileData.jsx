...
const ShopProfileData = ({ isOwner }) => {
  ...
  return (
    <div className="w-full">
      ...
      <br />
      <div className="grid grid-cols-1 gap-[20px] md:grid-cols-2 md:gap-[25px] lg:grid-cols-3 lg:gap-[25px] xl:grid-cols-4 xl:gap-[20px] mb-2 border-0">
        {productData &&
